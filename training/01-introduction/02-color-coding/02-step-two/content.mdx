...
While designing the smart home system for your dining room, you realise it's missing one essential element: a radio to listen to some cool jazz while having dinner. This device hasn't been added to your Capella model yet.

<Admonition variant={"warning"}>
  Task: Bring this idea to life by creating a physical component named "Radio"
  and placing it in the dining room. Once added, head over to the Property
  Values menu and assign it the Device_Type of "Audio Device."
</Admonition>
