...
- Click on the search icon (<InlineImage src="./search.png" alt="Search Icon" />) at the top of your interface (1).
- Type "Property Values" into the search bar.
- Select the Property Values tab (2) from the results (as shown in the image below).

![Open the Property Values view](./open-property-values.png)

Once you've followed these steps, the Property Values view (<InlineImage src="./property-values-icon.png" alt="Property Values Ico " />) will appear on your screen:

![Property Values view](./property-values-view.png)
...
![Property Values view with populated values](./property-values-view-populated.png)
