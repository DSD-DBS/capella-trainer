...
![](./PVMT_Chapter2_Part1_Image01.png)

You’ll encounter the following view:

![](./PVMT_Chapter2_Part1_Image02.png)
...
**Create a New Domain (<CaIcon name="createDomain" />)**: Picture a domain as a group of related properties you want to add to your model. It’s like defining the key aspects of your system (2)
