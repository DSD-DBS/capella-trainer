  ...
  return (
    <>
      <ScrollArea
        ...
        className="prose mx-auto max-w-screen-md grow rounded-md border-2 p-4 prose-h1:text-3xl prose-h1:font-bold prose-img:max-h-72 prose-img:max-w-full prose-img:object-contain"
      >
